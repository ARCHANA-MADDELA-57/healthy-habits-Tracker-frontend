...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    setStatus("loading");
    try {
      const res = await fetch("https://healthy-habits-tracker-backend.onrender.com/api/auth/login", {
        method: "POST",
  ...
  const handleRequestReset = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://healthy-habits-tracker-backend.onrender.com/api/auth/forgot-password",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleResetSubmit = async (e) => {
    ...
    setStatus("loading");
    try {
      const res = await fetch("https://healthy-habits-tracker-backend.onrender.com/api/auth/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
